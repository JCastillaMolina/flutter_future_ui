...
class Data{
  ...
  final List<Map<String, dynamic>> _dataCategory = [
    {
      "id": 1,
      "category": "Art & Cultures",
      "icons": "Icons.category",
      "color":"Colors(0xff5E6EFF)"
    },
    {
      "id": 2,
      "category": "Adventura",
      "icons": "Icons.emoji_people ",
      "color": "Colors(0xff00B0F0)",
    },
    {
      "id": 3,
      "category": "Festival",
      "icons": "Icons.camera_rounded",
      "color":"Colors(0xff5E6EFF)"
    },
  ];

  Future<List<Map<String,dynamic>>> fetchDataCategory() async{
    return Future.delayed(Duration(seconds: 2),(){
